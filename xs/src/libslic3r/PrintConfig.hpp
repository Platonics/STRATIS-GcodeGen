...
class GCodeConfig : public virtual StaticPrintConfig
{
    ...
    ConfigOptionInt                custom_gcode_layer_freq;
    ConfigOptionString              custom_gcode;
    ...
    GCodeConfig() : StaticPrintConfig() {
        ...
        this->custom_gcode_layer_freq.value                      = 0;
        this->custom_gcode.value                                 = "";
    };
    ...
    ConfigOption* option(const t_config_option_key opt_key, bool create = false) {
        ...
        if (opt_key == "custom_gcode_layer_freq")                    return &this->custom_gcode_layer_freq;
        if (opt_key == "custom_gcode")                               return &this->custom_gcode;
